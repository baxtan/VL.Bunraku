...
{
    public static Bunraku_AxisValues Bunraku_InverseKinematic(Bunraku_Robot robot, Bunraku_RobotBase baseConfig, Bunraku_Tool tool, Bunraku.Geometry.Plane targetPlane, string status, Bunraku_AxisValues prevAxisValues)
    {
