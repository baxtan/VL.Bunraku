...
using Bunraku.Kinematics.Geometry;
using static VL.Core.AppHost;
using Frame = Bunraku.Kinematics.Geometry.Frame;

namespace Bunraku.Kinematics
{
    /// <summary>
    ...
    {
        public static Kinematics_JointAxisValues Kinematics_InverseKinematic(
            Kinematics_BunrakuRobot robot,
            Kinematics_RobotBase robotBase,
            Kinematics_BunrakuTool tool,
            Frame targetFrame,
            string status,
            Kinematics_JointAxisValues prevJointAxisValues)
        {
            ...
            prevJointAxisValues ??= new Kinematics_JointAxisValues(0, -90, 90, 0, 0, 0);
            ...
            return Kinematics_EqualiseKinematics(
                prevJointAxisValues,
                new Kinematics_JointAxisValues(
                    A01deg,
                    A02deg,
                    A03deg,
                    A04deg,
        ...
        private static Kinematics_JointAxisValues Kinematics_EqualiseKinematics(
            Kinematics_JointAxisValues oldV,
            Kinematics_JointAxisValues newV)
        {
            return new Kinematics_JointAxisValues(
    ...
    public class Kinematics_JointAxisValues
    {
        public double a01_val, a02_val, a03_val, a04_val, a05_val, a06_val;

        public Kinematics_JointAxisValues(
        ...
        /// <summary>
        /// Returns the six joint‐axis values in order as a List<double>.
        /// </summary>
    ...
    public class Kinematics_BunrakuRobot
    {
        public double a01length = 400, a01offset = 25,
                      a02length = 455,
                      a03length = 420, a03offset = 25,
                      a04length = 90;
        public Kinematics_BunrakuRobot(double l1, double o1, double l2, double l3, double o3, double l4)
        {
    ...
    public class Kinematics_RobotBase
    {
        public double basevalA, basevalB, basevalC, basevalX, basevalY, basevalZ;
        public Kinematics_RobotBase() { }
        public Kinematics_RobotBase(double A, double B, double C, double X, double Y, double Z)
        {
    ...
    public class Kinematics_BunrakuTool
    {
        public double toolvalX, toolvalY, toolvalZ, toolvalA, toolvalB, toolvalC;
        public Kinematics_BunrakuTool() { }
        public Kinematics_BunrakuTool(double x, double y, double z, double a, double b, double c)
        {
